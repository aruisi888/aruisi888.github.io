...
class Spider(Spider):  # 元类 默认的元类 type
    ...
    def homeVideoContent(self):
        rsp = self.fetch("https://libvio.fun")
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        url = 'https://libvio.fun/show/{0}.html'.format(params)
        print(url)
        rsp = self.fetch(url)
        root = self.html(self.cleanText(rsp.text))
    ...
    def detailContent(self, array):
        tid = array[0]
        url = 'https://libvio.fun/detail/{0}.html'.format(tid)
        rsp = self.fetch(url)
        root = self.html(self.cleanText(rsp.text))
    ...
    def searchContent(self, key, quick):
        url = 'https://libvio.fun/index.php/ajax/suggest?mid=1&wd={0}'.format(key)
        # getHeader()
    ...
    def playerContent(self, flag, id, vipFlags):
        result = {}
        url = 'https://libvio.fun/play/{0}.html'.format(id)
        rsp = self.fetch(url)
        root = self.html(self.cleanText(rsp.text))
        ...
        for script in scripts:
            if (script.startswith("var player_")):
                ...
                break;
        nid = str(jo['nid'])
        scriptUrl = 'https://libvio.fun/static/player/{0}.js'.format(jo['from'])
